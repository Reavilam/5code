...
namespace AsignaSalones.App.Consola
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Mat.No. {0} - est. {1} - clase1 {2} - clase2 {3} - clase3 {4} ", matricula.id, matricula.estudiante.nombre, matricula.clase_1.nombre, matricula.clase_2.nombre, matricula.clase_3);
            }
            //AddEstudiante();
